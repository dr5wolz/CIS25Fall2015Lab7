		...
		case 3:
			if (initializeCheck == 1) {
				...
				if (rec1Area > rec2Area) {
					...
					cout << "\n      Rectangle 2 has a greater area of " << rec1Area
						<< "\n      than Rectangle 1's area of " << rec2Area << endl;
				}
			}
			else {
				cout << "\n      Please set values of the Rectangles First\n";
...
void mixedMenu(RectanglePeterW* rec1, RectanglePeterW* rec2, CirclePeterW* cir1, CirclePeterW* cir2) {
	...
	do {
		...
		case 1:
			...
			case 12:
				if (rec1Area > rec2Area) {
					cout << "\n      Circle 1 has a greater area of " << rec1Area
						<< "\n      than Circle 2's area of " << rec2Area << endl;
				} else if (rec1Area == rec2Area) {
					cout << "\n      Both Circles have an area of " << rec1Area;
				} else {
					cout << "\n      Circle 2 has a greater area of " << rec1Area
						<< "\n      than Cirlce 1's area of " << rec2Area << endl;
				}
			case 13:
					if (rec1Area > cir1Area) {
						cout << "\n      Circle 1 has a greater area of " << rec1Area
							<< "\n      than Circle 2's area of " << cir1Area << endl;
